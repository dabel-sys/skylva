  ...
  return (
    <section className="py-32 bg-white flex flex-col items-center justify-center text-center px-6">
      ...
      <p className="text-gray-500 font-sans font-light text-lg mb-12 max-w-lg">
        Visualize your structure in 3D. Customize materials, dimensions, and solar capacity.
      </p>
      <button className="group flex items-center space-x-4 bg-skylva-matte text-white px-12 py-5 text-sm font-bold tracking-[0.2em] uppercase hover:bg-skylva-green transition-all duration-500">
